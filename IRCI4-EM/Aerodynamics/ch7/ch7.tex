...
\subsubsection{Separation behavior}
	\wrapfig{9}{r}{6}{0.25}{ch7/8}{ch7/8}
 	...
 	\minifig{ch7/9}{ch7/10}{0.25}{0.2}{0.35}{0.3}
...
\subsubsection{Efficiency of flaps and ailerons}
	...
	\wrapfig{6}{l}{3}{0.25}{ch7/14}{ch7/14}
	...
	\wrapfig{5}{r}{4}{0.22}{ch7/15}{ch7/15} 
...
\subsubsection{Swept wing and supersonic flow}
	\minifig{ch7/16}{ch7/17}{0.25}{0.3}{0.35}{0.3}
...
\section{Area rule}
	...
	\minifig{ch7/18}{ch7/19}{0.25}{0.3}{0.35}{0.3}
	
	This means that the cross section of the fuselage must be reduced near the tail in order to have that smooth variation. 