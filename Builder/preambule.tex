...
\newcommand{\corollaire}[1]{\bigbreak\begin{tabular}{||c}
	\begin{minipage}{\textwidth-\widthof{\hspace{14.8pt}}}
		\textsc{Corollaire : } \textit{#1}
	\end{minipage}
	\end{tabular}}
\newcommand{\exemple}[1]{\bigbreak\begin{tabular}{|c}
	\begin{minipage}{\textwidth-\widthof{\hspace{12.4pt}}}
		\textsc{Exemple : } #1
	\end{minipage}
	\end{tabular}}
...
\newcounter{noteurcnt}
\newcommand\addnoteur[2]{%
	\stepcounter{noteurcnt}%
	\csdef{noteur\thenoteurcnt}{\mbox{#1~\textsc{#2}}}}
\newcommand\getnoteur[1]{%
	\csuse{noteur#1}}
