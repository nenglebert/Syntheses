...
\begin{titlepage}
	\begin{center}	
		...
		\includegraphics[width=1\textwidth]{../../Builder/titlepage/logo.pdf}~\\[1cm]				%Logo
			%0.55
			...
			\begin{minipage}[t]{0.6\textwidth}
				\begin{flushleft}%\large
					\emph{\iflanguage{british}{Autor}{Auteur}\ifnum\theauteurcnt>1 s\fi:}\\
					\whileboolexpr
					...
					{\stepcounter{iter}\getnoteur{\theiter}\\}%
					\setcounter{iter}{0}%
					\fi%
