...
emmagasiné dans $\mathcal{D}$ soit à l'extérieur à travers $S$.
	...
	\retenir{\begin{equation}
	\vec{\mathcal{S}}(\vec{r},\omega) = \dfrac{1}{2Z_0}|\vec{E}|^2\vec{1_r},\qquad\qquad\qquad
...
vouloir utiliser $q\vec{v}\times\vec{B}$ mais c'est mort sans vitesse. Il va falloir ruser.
	...
	\end{equation}
	où $\underline{\vec{E_i}}(l)$ est le champ incident sur le circuit, $\underline{I_a}, \underline{I}(l)$ 
