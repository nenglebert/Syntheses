...
\section{La structure des polymères}
	\subsection{Quelques polymères courants}
		...
		\begin{minipage}{0.5 \textwidth}
			\begin{flushleft}
				\includegraphics[scale=0.72]{ch3/10p}
			\end{flushleft}
		\end{minipage}
		\begin{minipage}{0.5 \textwidth}
			\begin{flushright}
				\includegraphics[scale=0.72]{ch3/11p}
			\end{flushright}
		\end{minipage}
		\ \\
	...
	\subsection{Polymérisation}
		\subsubsection{En chaîne}
			...
			\vspace{-5mm}
			\includegraphics[scale=0.8]{ch3/13}
			\end{wrapfigure}	
	...
	\subsubsection{Par étape}
		...
		\vspace{-5mm}
		\includegraphics[scale=0.5]{ch3/14}
		\end{wrapfigure}	
	...
	\subsection{Masse molaire moyenne et distribution}
		...
		\vspace{-5mm}
		\includegraphics[scale=0.5]{ch3/15}
		\end{wrapfigure}	
	...
	\subsection{Configuration géométrique}
		\subsubsection{Isomérie de séquence}
			...
			\vspace{-5mm}
			\includegraphics[scale=0.4]{ch3/16}
			\end{wrapfigure}	
		...
		\subsubsection{Isomérie de structure}
		\begin{wrapfigure}[7]{l}{6cm}
		\vspace{-5mm}
		\includegraphics[scale=0.5]{ch3/17}
		\end{wrapfigure}	
		...
		\begin{wrapfigure}[7]{r}{6cm}
			\vspace{-5mm}
			\includegraphics[scale=0.55]{ch3/18}
			\end{wrapfigure}	
	...
	\subsubsection{Classification selon la structure}
	\begin{wrapfigure}[8]{l}{6cm}
			\vspace{-5mm}
			\includegraphics[scale=0.36]{ch3/19}
			\end{wrapfigure}	
	...
	\begin{wrapfigure}[8]{r}{6cm}
			\vspace{-10mm}
			\includegraphics[scale=0.4]{ch3/20}
			\end{wrapfigure}	
