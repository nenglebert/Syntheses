...
\begin{figure}[H]
	\centering
	\subfigure[Single-ended]{\label{fig:multsing}\includegraphics[width=0.5\textwidth]{ch3/image15}}
	\subfigure[Différentiel]{\label{fig:mutldiff}\includegraphics[height=20\baselineskip]{ch3/image16}}
