...
\begin{center}
	...
	\captionof{figure}{Conversion entre bases utiles}
\end{center}
...
\begin{itemize}
	...
	\begin{center}
		\begin{tabular}{|c|c|c|c|}
			...
			\hline
		\end{tabular}
		\captionof{table}{IEEE 754 - Simple Précision}
	\end{center}
	...
	\begin{center}
		\begin{tabular}{|c|c|c|c|}
			...
			\hline
		\end{tabular}
		\captionof{table}{IEEE 754 - Double Précision}
	\end{center}
\end{itemize}
