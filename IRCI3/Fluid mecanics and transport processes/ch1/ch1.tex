...
\end{wrapfigure}
We have said that gases viscosity increased with temperature. It's due to the kinetic approch that gived us the equation \eqref{equation:1.15} where $\mu \propto \sqrt{T}$. \\
