...
\section{Bernoulli equation}
	...
	\end{equation}	 
		...
		\end{itemize} }
		\ \\ Finally, we can say that the sum of these 3 types of pressure is the \textbf{total pressure} and that it's constant along a streamline. 
