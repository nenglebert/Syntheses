...
En effet, le champ en $L$ peut être exprimé en terme du champ en 0 (cf. système d'équation ci-dessus).
...
Il ne faut pas oublier la réflexion de $E_-$ en 0 qui vient "nourrir" $E_+$.
...
\end{equation}
	...
	\begin{wrapfigure}[6]{l}{3cm}%on ne peut pas lire la phrase cachée sous l'image
	\vspace{-15mm}
...
être décrite par $"r"$ alors que celle à l'extérieur doit être décrite par $r$ de sorte à obtenir%ce que tu avais écrit changeait la fonction de Airy
\begin{equation}
\begin{array}{lll}
E_r &= -rE_i+tE_-(0) &= -rE_i +rtE_+(0)e^{2i\beta L}\\
&= -rE_i + rE_te^{i\beta L} &= -rE_i+rT_{FP}e^{i\beta L}E_i
...
En continuant, on aura par interférences constructives, la formation d'un champ important.\\% Phrase à reformuler car la condition du nombre de ventres et de noeuds dépend de la longueur de la cavité
