...
\section{Fonctions de Bessel}
	...
	\end{array}
	\end{equation}
	En mettant tout ensemble, on se rend compte que le terme de la série doit forcément 
	...
	\subsection{La fonction $\mathcal{Y}_p$}
	...
	\subsection{$x$-orthogonalité des fonction $J_p(x)$}
