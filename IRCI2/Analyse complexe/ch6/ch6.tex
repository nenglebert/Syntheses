...
\section{Résidu et théorème des résidus}
	...
	Le résidu de $f$ au point singulier $z_0$ est la coefficient de $\frac{1}{z-z_0}$ 
	...
	\begin{proof}\ \\
	Découle directement du théorème de Cauchy-Goursat, la troisi!me proposition :
	\begin{equation}
	...
	\end{eqnarray}
	le résidus (de cette fonction) étant le coefficient de $1/z\rightarrow$ résidus = $-1/2$\\
	...
	\end{eqnarray}
	le résidu vaut donc respectivement pour $z=1$ et $z=2$, 2 et 3.\\
...
\section{Calcul du résidu}
	...
	\begin{equation}
	f(z) = \sum_{n=0}^\infty a_n(z-z0)^n + \frac{b_1}{z-z_0} + \frac{b_2}{(z-z_0)^2}+\dots 
	\end{equation}		
	...
	\item Si $b_n= \forall n$ alors $z_0$ est un \textbf{point singulier artificiel} de $f(z)$.
