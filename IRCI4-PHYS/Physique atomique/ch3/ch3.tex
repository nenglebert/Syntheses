...
Prochain cours :D
 ...
 \iffalse
 on avait ça dans la cste de spin orbite. 

Comme dans atome de H, on aura pas assez avec l et s. On avait couplé l et s pour avoir j. Ici on avait couplé l1 l2 pour avoir L et pareil pour avoir S

---

Si on a deux elec : tout ce qu'on a vu dans l'étome de H c'est vrai sauf que c'était simple.. 


--- sur ALS
Si on veut faire proporement faut la somme au dessus. Mais on fait ça ici : marche tres bien en nucléaire, bof en atomique : mais L.S c'est facile

--- sur cadre
Différence entre deux niveau c'est J (le supérieur). On s'attend à un rapport 3/2 expérimentalement. Si c'est ça cool, sinon 
