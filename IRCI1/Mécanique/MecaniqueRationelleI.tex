...
\title{Synthèse du cours Mécanique rationelle I}
\date{Février 2014}
...
L'ojbet de la statique est l'étude des conditions d'équilibre. Un \textit{point matériel} est dit en équilibre lorsqu'il reste indéfiniment au repos lorsqu'il est abandonné sans vitesse.
...
Le nombre de dégrés de liberté d'un solide est le nombre nécessaire et suffisant de paramètres indépendants permettant de déterminer la position de tous les points de ce corps.\\\\
