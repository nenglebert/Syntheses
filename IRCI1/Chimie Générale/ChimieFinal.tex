...
\begin{center}	
	...
	\HRule \\[0.4cm]
	{ \huge \bfseries Chimie générale \\[0.4cm] }
...
\subsection{Application de la constante d'équilibre}
...
\subsection{Résolution de problèmes d'équilibres}
Pas de points théoriques, partie intégralement pratique (\textit{cf. TP}).

\subsection{Principe de le Chatelier}
...
\newpage
\section{Solubilité et réactions de précipitation}
\subsection{Réactions de précipitation et stœchiométrie de ces réactions}
...
\subsection{Équilibrage des réactions d'oxydo-réduction}
\subsubsection{En solution acide}
...
\subsubsection{En solution basique}
...
\newpage
\section{Changement de phase et propriétés des solutions}
\subsection{Changement de phases}
...
\subsection{Équation de vitesse}
...
\subsubsection{Théorie du complexe activé ( = de l'état de transition)}
...
\subsubsection{Électrolyse d'un mélange d'ions}
\textit{Cf. slide 45}\\
...
\subsection{Propriétés des éléments d'un groupe donné : les métaux alcalins}
